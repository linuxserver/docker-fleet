...
Simply pulling `ghcr.io/linuxserver/fleet` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Update the image: `docker pull ghcr.io/linuxserver/fleet`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/fleet:latest .
```
